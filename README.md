...
**SimpleTweet** is an android app that allows a user to view his or her Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
